## 문서간 공통 어휘 추출 ##
'''
문서 간 공통 어휘를 측정하여 유사도를 측정할 수 있음
'''
...
# """
story1="It ain't hard to tell"
story2= "If I ain't got you"
...
'''
casefold () 메서드는 문자열에있는 모든 대 / 소문자 구분을 제거합니다. 
캐스 매치 매칭에 사용됩니다. 즉 비교할 때 사례를 무시합니다.'''